          ...
          <div className="text-center mb-8">
            ...
            {pendingVerification ? (
              <>
                ...
                <p className="text-muted-foreground mt-1">We sent a code to {email}</p>
              </>
            ) : (
              <>
            ...
            <form onSubmit={handleVerification} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-background border border-border text-sm focus:outline-none focus:border-primary transition-colors text-center text-2xl tracking-widest"
                  maxLength={6}
                  required
                />
              </div>
